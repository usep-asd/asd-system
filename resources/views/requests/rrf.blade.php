...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Repair Request Form - General Services Unit') }}</h1>
                    ...
                    <form method="POST" action="" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="mode">Mode of Request<span class="small text-danger">*</span></label>
                                        <select class="form-control">
                                            <option hidden>Select Mode of Request</option>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="nature">Nature of Request</label>
                                        <select class="form-control">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="details">Request Details<span class="small text-danger">*</span></label>
